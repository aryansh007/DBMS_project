...
public class SalesReport {
	...
	public SalesReport() {
		...
		private void initialize(){
			...
			chckbxNewCheckBox.setBackground(new Color(220, 20, 60));
			...
			chckbxFilterByYear.setBackground(new Color(220, 20, 60));
			...
			chckbxNewCheckBox_1.setBackground(new Color(220, 20, 60));
			...
			chckbxSortByDate.setBackground(new Color(220, 20, 60));
